...
xCoordsIdealFullGrid, yCoordsIdealFullGrid = find_pinhole_centroids.put_down_grid_guesses([110,-110],48.0,[100,512],-1e-9,-3.2) # sets down an 'ideal' set of pinholes made to match the real pinholes as closely as possible
# approxHoleSpacingPass,barrelCenterPass,barrelDegreePass,rotationAnglePass

import ipdb; ipdb.set_trace()
xCoordsFoundAutomated, yCoordsFoundAutomated = find_pinhole_centroids.find_psf_centers(imagePinholes,20.,30000.) # finds the actual st of pinholes
...
# connect the automated pinhole locations with counterparts in the model grid
